                            ...
                            <ul>
                                <li class="d-flex mb-4"> <i class="fas fa-map-marker-alt text-white mr-2 font-13 mt-1"></i>
                                    <div class="contact-address">
                                        ...
                                        <span class="text-white">Kormangala,Bangalore</span> <br>
										<span class="text-white">Kormangala,Bangalore</span>
										</div>
                                </li>
                                ...
                                <li class="d-flex mb-4"> <i class="fas fa-envelope text-white mr-2 font-13 mt-1"></i>
                                    <div class="contact-address">
										...
										<span class="d-table text-white">helpline@sanps.com</span>
										<span class="text-white">helpline@sanps.com</span>
										</div>
                                </li>
                            </ul>
                        </div>
